...
<ul>
<li>工数ログだけでプロジェクトが表示されないよう、メンバー/オーナー条件を必須化</li>
</ul>
</details>
## 2026-01-28 (v1.410h)
- 概要: 週次の「なし」等の空入力を除外
...
<summary>個別の変更内容</summary>
<ul>
<li>課題/実施が「なし」等のみの週次行は表示判定から除外</li>
</ul>
</details>
## 2026-01-28 (v1.410g)
- 概要: 週次の完了プロジェクトを非表示に
...
<summary>個別の変更内容</summary>
<ul>
<li>週次レポートが空（課題/実施が空）の場合は表示プロジェクトに含めない</li>
</ul>
</details>
## 2026-01-28 (v1.410e)
- 概要: 週次の無関係プロジェクト表示を抑制
<details>
<summary>個別の変更内容</summary>
<ul>
<li>週次に表示するプロジェクトを「実績/週次記録/担当タスク/オーナー」に限定</li>
</ul>
</details>
## 2026-01-28 (v1.410d)
- 概要: 自動休憩の強制切替を停止
...
<summary>個別の変更内容</summary>
<ul>
<li>0時まで退勤打刻がない場合、定時（未設定時18:00）で退勤扱い</li>
<li>出勤カード/カレンダー/集計に適用</li>
</ul>
</details>
## 2026-01-28 (v1.410b)
- 概要: 休憩スケジュールの事前記録と表示改善
<details>
<summary>個別の変更内容</summary>
<ul>
<li>出勤時に休憩スケジュールを当日分として事前記録</li>
<li>休憩時間帯は自動的に休憩表示（更新依存を解消）</li>
</ul>
</details>
## 2026-01-27 (v1.410a)
